...
import io.zcw.zipmint.config.audit.AuditEventConverter;
import io.zcw.zipmint.domain.PersistentAuditEvent;
...
import static io.zcw.zipmint.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
