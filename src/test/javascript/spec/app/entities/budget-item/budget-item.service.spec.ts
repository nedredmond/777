...
import { IBudgetItem, BudgetItem, Category } from 'app/shared/model/budget-item.model';
...
describe('Service Tests', () => {
    describe('BudgetItem Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should update a BudgetItem', async () => {
                const returnedFromService = Object.assign(
                    {
                        expectedSpending: 1,
                        actualSpending: 1,
            ...
            it('should return a list of BudgetItem', async () => {
                const returnedFromService = Object.assign(
                    {
                        expectedSpending: 1,
                        actualSpending: 1,
            ...
            it('should delete a BudgetItem', async () => {
