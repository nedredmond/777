...
import { IMoneyAccount, MoneyAccount, AccountType } from 'app/shared/model/money-account.model';
...
describe('Service Tests', () => {
    describe('MoneyAccount Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a MoneyAccount', async () => {
            ...
            it('should update a MoneyAccount', async () => {
                const returnedFromService = Object.assign(
                    {
                        type: 'BBBBBB',
                        accountTotal: 1,
            ...
            it('should return a list of MoneyAccount', async () => {
                const returnedFromService = Object.assign(
                    {
                        type: 'BBBBBB',
                        accountTotal: 1,
            ...
            it('should delete a MoneyAccount', async () => {
